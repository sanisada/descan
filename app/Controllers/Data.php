...
class Data extends BaseController
{
    ...
    public function save1($data_id)
    {
        ...
        $dataModel->update($data_id, [
            ...
            'R106A' => $requestData['R106A'],
            'R304'   => $requestData['R304'],
            'R307B1'   => $requestData['R307B1'],
            'R307B1_LAT' => $requestData['R307B1_LAT'],
            'R307B1_LA0' => $requestData['R307B1_LA0'],
            'R307B1_LON' => $requestData['R307B1_LON'],
            'R307B2' => $requestData['R307B2']
        ]);
    ...
    public function save10($data_id)
    {
        ...
        $dataModel->update($data_id, [
            ...
            'R1601BK6'   => $this->request->getPost('R1601BK6'),
