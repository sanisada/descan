...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="<?php echo base_url('data/detail6/'.$data['data_id'])?>"><button type="button" name="back" class="btn btn-md btn-secondary"><i class="fas fa-arrow-left"></i>&ensp;Sebelumnya</button></a>
                <a href="<?php echo base_url('data/detail8/'.$data['data_id'])?>"><button type="button" name="next" class="btn btn-md btn-info float-md-right">Selanjutnya&ensp;<i class="fas fa-arrow-right"></i></button></a>
            </div>
        </div>
        </form>
    </div>
