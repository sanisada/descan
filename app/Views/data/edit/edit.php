...
<section class="content">
    <div class="container-fluid">
        <!-- Default box -->
        <form action="<?php echo base_url('data/simpan1/').$data['data_id'] ?>" method="POST">
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                                                        ...
                                                        <div class="col-md-12 form_field_outer p-0">
                                                            <div class="row form_field_outer_row">
                                                                ...
                                                                <div class="form-group col-md-1">
                                                                    <a href="<?php echo base_url('data/hapusSls/' . $slsItem['sls_id']) ?>/<?= ($slsItem['data_id']) ?>" class="removeInput btn btn-sm btn-danger" type="button" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
