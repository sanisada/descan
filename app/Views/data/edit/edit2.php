...
<section class="content">
    <div class="container-fluid">
        <!-- Default box -->
        <form action="<?php echo base_url('data/simpan2/').$data['data_id']  ?>" method="POST">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="<?php echo base_url('data/edit/'.$data['data_id'])?>"><button type="button" name="back" class="btn btn-md btn-secondary">Sebelumnya</button></a>
...
<script>
    ...
    function on_change2(el){
        ...
        window.localStorage.setItem('R304B', selectedOption);
    }
