                            ...
                            <div class="col-md-12">
                                ...
                                <!-- <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div id="pendidikan-<?php echo $i ?>" class="form-group pendidikan" style="display:none;">
                                            <hr/>
                                            <h6>Jika tidak ada lembaga pendidikan di desa/kelurahan, untuk mencapai sarana pendidikan terdekat</h6>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?php for ($k = 203; $k < 258; $k++): ?>
                                                    <label for=""><?php echo $ques[$k]['ques_label'] ?></label>
                                                    <input type="number" name="<?php echo $ques[$k]['dataKey'] ?>" value="<?php echo $data[$ques[$k]['dataKey']] ?>" class="form-control">
                                                    <?php endfor ?>
                                                </div>
                                                <div class="col-md-6">
                                                    <?php for ($k = 204; $k < 258; $k++): ?>
                                                    <label for=""><?php echo $ques[$k]['ques_label'] ?></label>
                                                    <div style="margin-bottom:-9.5px;">
                                                        <div class="form-check-inline">
                                                            <input class="form-check-input" type="radio" name="<?php echo $ques[$k]['dataKey'] ?>" value="1" <?php if ($data[$ques[$k]['dataKey']] == 1) echo "checked"; ?>>
                                                            <label class="form-check-label">Sangat mudah</label>
                                                        </div>
                                                        <div class="form-check-inline">
                                                            <input class="form-check-input" type="radio" name="<?php echo $ques[$k]['dataKey'] ?>" value="2" <?php if ($data[$ques[$k]['dataKey']] == 2) echo "checked"; ?>>
                                                            <label class="form-check-label">Mudah</label>
                                                        </div>
                                                        <div class="form-check-inline">
                                                            <input class="form-check-input" type="radio" name="<?php echo $ques[$k]['dataKey'] ?>" value="3" <?php if ($data[$ques[$k]['dataKey']] == 3) echo "checked"; ?>>
                                                            <label class="form-check-label">Sulit</label>
                                                        </div>
                                                        <div class="form-check-inline">
                                                            <input class="form-check-input" type="radio" name="<?php echo $ques[$k]['dataKey'] ?>" value="4" <?php if ($data[$ques[$k]['dataKey']] == 4) echo "checked"; ?>>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td id="jumlah-meninggal-<?php echo $i ?>" class="penderita" style="display:none;">
                                            <label for=""><?php echo $ques[$i+2]['ques_label'] ?></label>
                                                <input type="number" name="<?php echo $ques[$i + 2]['dataKey'] ?>" value="<?php echo $data[$ques[$i + 2]['dataKey']] ?>" class="form-control">
                                            </td>
                                        </tr>
